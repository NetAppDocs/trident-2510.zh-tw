...
* 使用 Trident 搭配 https://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Files"^]時可能遇到的一個常見問題是，租用戶金鑰和用戶端金鑰來自權限不足的應用程式註冊。有關 Trident 要求的完整清單，請參閱link:trident-use/anf.html["Azure NetApp Files"^]組態。
