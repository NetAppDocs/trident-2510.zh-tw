...
檢查 link:../trident-install/kubernetes-deploy.html["安裝概述"] 以確保滿足安裝先決條件並為您的環境選擇了正確的安裝選項。

.開始之前
除了 link:../trident-install/kubernetes-deploy.html#before-you-deploy["部署先決條件"] 之外，您還需要 link:https://v3.helm.sh/["Helm 版本 3"^]。
